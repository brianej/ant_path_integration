...
save("/home/ubuntu/MATLAB-Drive/summer24_pathIntegration/nest1.mat", "Record", "raw_images", "radius1", "radius2", "radius3", "num_views", "nest_x", "nest_y", "facing_nest_views");
...
for i_ant = 1
    ...
    while distance_travelled < distance_near_nest + radius1 * 2
        ...
        EN_response.activity(number_steps).scan = EN_pool;
    ...
    save(sprintf('/home/ubuntu/MATLAB-Drive/summer24_pathIntegration/result/heuristics/ant%droute1.mat',count),'navigation_result');
    count = count + 1;
end
...
plot(circle_x2, circle_y2, '-.', 'Color', [0.2 0.3 0.8], 'LineWidth', 1);

% Plot the second circle around the nest with a different style
circle_x3 = nest_x + radius3* cosd(0:360);
circle_y3 = nest_y + radius3 * sind(0:360);
plot(circle_x3, circle_y3, '-.', 'Color', [0.3 0.5 0.7], 'LineWidth', 1);

xlabel('X', 'FontSize', 12);
ylabel('Y', 'FontSize', 12);
title('Ant Route Home', 'FontSize', 14);
legend('Route Home', 'Nest Location', 'Nest Radius 1', 'Nest Radius 2', 'Nest Radius 3', 'Initial Foraging Route', 'Location', 'best');
grid on;
hold off;
