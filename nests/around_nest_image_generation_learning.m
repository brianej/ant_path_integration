...
[nest_x, nest_y] = nest_generator(radius1, world_bound);

% generate views of around the nest from x(radius) away from the nest
% facing the nest
facing_nest_views = around_nest_views(nest_x, nest_y, radius1, radius2, num_views);
...
save("./ant_data/nest1.mat", "Record", "raw_images", "radius1", "radius2", "num_views", "nest_x", "nest_y", "facing_nest_views");
